...
#ifdef NON_MATCHING
//Matching scratch here: https://decomp.me/scratch/hgijW
//Needs object or particle struct definition updates now to match again
void func_800B3740(Object *obj, Gfx **dlist, MatrixS **mtx, Vertex **vtx, s32 flags) {
    ...
    if ((obj->segment.header->unk0 & flags) && (D_800E2CDC < 0x200)) {
        return;
    }
    alpha = (obj->unk5C->unk0 >> 8) & 0xFF;
    if(alpha <= 0) {
        return;
    }
    if ((obj->segment.object.unk2C != 4) && (obj->segment.object.unk2C != 3)) {
        gDPSetEnvColor((*dlist)++, obj->unk6C->red, obj->unk6C->green, obj->unk6C->blue, obj->unk6C->alpha);
        if (alpha != 255) {
        ...
        if (obj->segment.object.unk2C == 0x80) {
        ...
        gDPSetEnvColor((*dlist)++, 255, 255, 255, 0);
        if (obj->segment.object.unk2C == 4) {
            if (obj->segment.camera.unk3A > 0) {
        ...
        } else if (obj->segment.object.unk2C == 3) {
            gDPSetPrimColor((*dlist)++, 0, 0, obj->unk4A, obj->unk4A, obj->unk4A, alpha);
            if (obj->unk68[0]->texHeader->width >= 2) {
                sp30 = obj->unk44_0;
                load_and_set_texture(dlist, (TextureHeader *) sp30->unk0Ptr, renderFlags, obj->segment.animFrame << 8);
                gSPVertexDKR((*dlist)++, OS_K0_TO_PHYSICAL(sp30->unk0struct.unk8), sp30->unk0struct.unk4, 0);
                gSPPolygon((*dlist)++, OS_K0_TO_PHYSICAL(sp30->unk0struct.unkC),  sp30->unk0struct.unk6, 1);
            } else if (obj->unk68[0]->texHeader->width > 0) {
                sp30 = obj->unk44_0;
                load_and_set_texture(dlist, (TextureHeader *) sp30->unk0Ptr, renderFlags, obj->segment.animFrame << 8);
