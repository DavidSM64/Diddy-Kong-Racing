...
void func_800B0010(Particle2 *arg0, Particle2 *arg1, unk800B03C0_arg2 *arg2, ParticleBehavior *arg3) {
    ...
    if (sp3C) {
        if (sp3C & 0x100) {
            arg0->segment.x_velocity += (f32) get_random_number_from_range(-arg3->unk74, arg3->unk74) * 0.00001525878906f;
        }
        if (sp3C & 0x200) {
            arg0->segment.y_velocity += (f32) get_random_number_from_range(-arg3->unk78,  arg3->unk78) * 0.00001525878906f;
        }
        if (sp3C & 0x400) {
            arg0->segment.z_velocity += (f32) get_random_number_from_range(-arg3->unk7C, arg3->unk7C) * 0.00001525878906f;
        }
    }
    ...
    if (arg3->flags & 4) {
        ...
        sp3C = arg3->unk5C;
        if (sp3C & 0x10) {
            sp30.z += (f32) get_random_number_from_range(-arg3->unk70, arg3->unk70) * 0.00001525878906f;
        }
        if (sp3C & 0x60) {
...
void func_800B03C0(Particle2 *arg0, ObjectTransform *arg1, unk800B03C0_arg2 *arg2, ParticleBehavior *arg3) {
    ...
    if (arg3->unk5C & 0x80000) {
        arg0->unk58_f32 += (f32) get_random_number_from_range(-arg3->unk94, arg3->unk94) * 0.00001525878906f; // 0.00001525878906 ~= 1.0/65536.0
    }
    if (arg3->flags & 1) {
        sp30.x = 0.0f;
        sp30.y = 0.0f;
        ...
        sp3C = arg3->unk5C;
        if (sp3C & 1) {
            sp30.z += (f32) get_random_number_from_range(-arg3->unk60, arg3->unk60) * 0.00001525878906f;
        }
        if (sp3C & 6) {
