    ...
    if (arg1 < 19 && arg0 >= 0 && arg0 < 4) {
        ...
        if (D_801241B8[index].unk0 == arg1) {
            ...
            if (sUnkMiscAsset19[arg1 * 2] != 0) {
                func_80072578(arg0, sUnkMiscAsset19[arg1 * 2], sUnkMiscAsset19[(arg1 * 2) + 1]);
            }
        }
    }
}
...
void func_80072578(s16 arg0, s16 arg1, s16 arg2) {
    ...
    if ((D_801241E4 != 0) && (arg0 >= 0) && (arg0 < 4)) {
        new_var2 = func_80072250(arg0);
        index = 0xFFFF;
        index = index & new_var2;
        new_var = 1 << index;
        D_801241E6 |= new_var;
        D_801241E7 &= ~new_var;
...
// UNUSED
GLOBAL_ASM("asm/non_matchings/save_data/func_8007267C.s")
