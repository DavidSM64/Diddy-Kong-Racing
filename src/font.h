...
/* 0x02 */ unsigned char *text; // Pointer to the text array
...
/* 0x02 */ u8 unk2;
/* 0x03 */ u8 unk3;
/* 0x04 */ unsigned char *text; // Pointer to the text array
/* 0x08 */ s16 posX;
/* 0x0A */ s16 posY;
/* 0x0C */ s16 unkC;
/* 0x0E */ s16 unkE;
...
s32 func_800C4DA0(unsigned char *text, s32 x, s32 font); //Non Matching
