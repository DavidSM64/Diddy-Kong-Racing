...
void func_80052988(Object *obj, Object_Racer *racer, s32 action, s32 arg3, s32 duration, s32 arg5, s32 arg6, s32 arg7) {
    ...
    if ((gCurrentPlayerIndex == -1) && (action >= 3)) {
        obj->segment.unk3A.byte.lower = 0;
        racer->unk1F2 = 0;
    } else if (obj->segment.unk3A.byte.lower == 0) {
        if (arg6 & 1) {
            if (obj->segment.animFrame >= 41) {
                obj->segment.animFrame -= arg7 * 4;
                if (obj->segment.animFrame < 41) {
                    obj->segment.unk3A.byte.lower = action;
    ...
    } else if (obj->segment.unk3A.byte.lower == action) {
        if (arg6 & 2) {
...
void handle_racer_items(Object *obj, Object_Racer *racer, UNUSED s32 updateRate) {
    ...
    if (racer->held_obj != NULL) {
        ...
        if (gCurrentButtonsPressed & Z_TRIG || racer->raceFinished || racer->attackType) {
            var_f2 = 0;
            var_f12 = 0;
            if (obj->unk68[obj->segment.unk3A.byte.upper] != NULL) {
                temp_a1 = obj->unk68[obj->segment.unk3A.byte.upper]->objModel;
