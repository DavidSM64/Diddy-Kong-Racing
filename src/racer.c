...
void func_80046524(s32 updateRate, f32 updateRateF, Object *obj, Object_Racer *racer) {
    ...
    D_8011D558 = 0;
    sp110 = obj->segment.trans.x_position;
    sp10C = obj->segment.trans.y_position;
    sp108 = obj->segment.trans.z_position;
    spC8 = 1.0 - (gDialogueCameraAngle / 10240.0f);
    spE8 = -racer->ox1 * 10 * spC8;
    spE4 = -racer->oz1 * 10 * spC8;
    var_f2 = 8.0f;
    ...
    var_v0 = var_f18;
    var_f0 = var_f18 - var_v0;
    var_f18 = (gCurrentRacerMiscAssetPtr[var_v0 + 1] * var_f0) + (gCurrentRacerMiscAssetPtr[var_v0] * (1.0 - var_f0));
    ...
    if (gCurrentStickY < 0) {
        var_f16 = -gCurrentStickY;
        var_f14 *= 1.0 + (var_f16 / 112.0);
        var_f18 *= 1.0 - (var_f16 / 300.0);
    }
    var_f14 *= gCurrentRacerHandlingStat;
    racer->steerVisualRotation -= (((s32) var_f14) & 0xffff) & 0xffff;
    ...
    for (i = 0; i < 4; i++) {
        ...
        if (lastWheelSurface < racer->wheel_surfaces[i]) {
            lastWheelSurface = racer->wheel_surfaces[i];
        }
    ...
    var_f18 *= handle_racer_top_speed(obj, racer) * 1.7;
    if (racer->boostTimer > 0) {
        if (gRaceStartTimer == 0) {
            spF4 = 1.0f;
            spF0 = 0.0f;
    ...
    if (racer->zipperDirCorrection == 0) {
        if (gCurrentPlayerIndex == PLAYER_COMPUTER && !racer->raceFinished) {
            ...
            obj->segment.x_velocity += racer->ox1 * var_f12;
            obj->segment.y_velocity += racer->oy1 * var_f12;
            obj->segment.z_velocity += racer->oz1 * var_f12;
        } else {
    ...
    var_f4 = 10.0;
    spE8 += racer->ox1 * var_f4 * spC8;
    spE4 += racer->oz1 * var_f4 * spC8;
    if (racer->approachTarget == NULL) {
        ...
        if (
            move_object(obj, (var_f16 * updateRateF) + spE8, obj->segment.y_velocity * updateRateF, (var_f12 * updateRateF) + spE4) 
    ...
    waveProperties = get_wave_properties(obj->segment.trans.y_position, &sp118, &spD4); \
    if (waveProperties) {
    ...
    if (racer->buoyancy > 0.0) {
        ...
        rotate_racer_in_water(obj, racer, &spD4, waveProperties, updateRate, i, 1.0f);
    }
    if (racer->buoyancy > 0.0) {
    ...
    var_f16 = ((obj->segment.trans.x_position - (sp110 + spE8)) - D_8011D548) * var_f2;
    var_f12 = ((obj->segment.trans.z_position - (sp108 + spE4)) - D_8011D54C) * var_f2;
    obj->segment.z_velocity = var_f12;
    obj->segment.x_velocity = var_f16;
    obj->segment.y_velocity = (obj->segment.trans.y_position - sp10C) * var_f2;
    ...
    if (racer->groundedWheels == 0 && racer->waterTimer == 0) {
        i = (-gCurrentStickY * 0x40) & 0xFFFF;
        var_v1 = i - (obj->segment.trans.x_rotation & 0xFFFF);
        if (var_v1 > 0x8000) {
            var_v1 -= 0xFFFF;
        }
        if (var_v1 < -0x8000) {
    ...
    if (gCurrentButtonsPressed & R_TRIG && (racer->buoyancy > 0.0f || racer->groundedWheels >= 2) &&
        ...
        var_f2 = ((f32) ((2.0 * obj->segment.y_velocity) / gCurrentRacerWeightStat));
