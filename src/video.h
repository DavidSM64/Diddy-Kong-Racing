...
extern u16 *gVideoWriteFramebuffer;
extern u16 *gVideoReadyFramebuffer;
extern u16 *gVideoFrontFramebuffer;
extern u16 *gVideoWriteDepthBuffer;
extern u16 *gVideoReadyDepthBuffer;
extern u16 *gVideoFrontDepthBuffer;
