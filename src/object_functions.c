    ...
    if ((obj->interactObj->distance < 100) && !(obj->segment.trans.unk6 & 0x4000)) {
        ...
        for (i = 0; i < numObjects; i++) {
            ...
            if ((racer->unk1F5 == 0) && (racer->boostTimer < 15)) {
                ...
                if (((xDiff * xDiff) + (yDiff * yDiff) + (zDiff * zDiff)) < 100.0f * 100.0f) {
                    racer->unk1F5 = 1;
                    racer->unk14C = obj;
                }
            }
    ...
    if ((s32) obj->interactObj->distance < obj->unk78) {
        ...
        for (i = 0; i < numObjects; i++) {
            ...
            if ((racer->boostTimer < 15) && (racer->unk1E2 != 0)) {
                ...
                yDiff = curRacerObj->segment.trans.y_position - obj->segment.trans.y_position;
                zDiff = curRacerObj->segment.trans.z_position - obj->segment.trans.z_position;
                if ((s32) ((xDiff * xDiff) + (yDiff * yDiff) + (zDiff * zDiff)) < obj->unk78 * obj->unk78) {
                    if (racer->playerIndex != PLAYER_COMPUTER) {
        ...
        if (obj->interactObj->distance < obj64->unk10) {
            ...
            for (i = 0; i < numberOfRacers; i++) {
                ...
                if ((racer->playerIndex != -1) && (racer->unk108 == 0)) {
                    ...
                    if ((((xDiff * xDiff) + (yDiff * yDiff) + (zDiff * zDiff)) < dist * dist)) {
