...
void obj_init_animation(Object *obj, LevelObjectEntry_Animation *entry, s32 arg2) {
    ...
    obj->y_rotation = entry->y_rotation << 8;
    obj->x_rotation = entry->x_rotation << 8;
    obj->z_rotation = entry->z_rotation << 8;
...
void obj_loop_snowball(Object *obj, s32 speed) {
    ...
    if (obj64->unk24 != 0) {
        if (obj64->unk20 == 0) {
            func_80009558(obj64->unk24, obj->x_position, obj->y_position, obj->z_position, 1, &obj64->unk20);
        } else {
...
void obj_loop_coincreator(Object *obj, s32 speed) {
  ...
  if (obj->unk78 <= 0) {
    newEntry.x = (s32) obj->x_position;
    newEntry.y = ((s32) ((s16) obj->y_position)) - 3;
    newEntry.z = (s32) obj->z_position;
    newEntry.size = 8;
    ...
    if (newBananaObj) {
      ...
      func_8003FC44(obj->x_position, obj->y_position - 14.0f, obj->z_position, 44, 34, 0.25f, 0);
      obj->unk7C.word = 0;
    }
...
void obj_loop_weather(Object *obj, s32 speed) {
  ...
  if (numberOfObjects != 0) {
    ...
    temp_f0 = obj->x_position - curObj->x_position;
    temp_f2 = obj->z_position - curObj->z_position;
    new_var = obj->unk78f;
    obj3c = obj->unk3C_a.unk3C;
