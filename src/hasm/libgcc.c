/* --------------------------------------------------------------------------------*/
/* Standard GCC toolchains typically provide these low-level routines via libgcc.  */
/* However, because an appropriate libgcc library may not be present depending on  */
/* the target environment, this file acts as a simplified workaround providing     */
/* essential runtime routines tailored specifically for the N64.                   */
/*                                                                                 */
/* Note: This file is NOT part of the original game source code.                   */
/* --------------------------------------------------------------------------------*/
