...
void func_800ADBC8(UNUSED s32 arg0) {
    ...
    sp24 = func_800707C4(D_80127C1C->objXYZ.y_rotation) * sp28;
    temp_f2 = func_800707F8(D_80127C1C->objXYZ.y_rotation) * sp28;
    temp_f14 = D_80127C1C->objXYZ.x_position + (temp_f2 - sp24);
    temp_f16 = D_80127C1C->objXYZ.y_position;
    temp_f18 = D_80127C1C->objXYZ.z_position + (-temp_f2 - sp24);
    if (D_800E2C94 != 0) {
