...
void func_8005F310(s32 updateRate, f32 updateRateF, Object *obj, Object_Racer *racer, u32 *input, u32 *buttonsPressed, s32 *startTimer) {
    ...
    racer->unk1EC = 0;
    sp3E = obj->segment.unk3A.byte.lower;
    ...
    obj->unk74 = 0;
    racer->unk16A = sp3A;
    obj->segment.unk3A.byte.lower = sp3E;
    obj->segment.animFrame = sp3C;
    if ((racer->attackType != ATTACK_NONE) && (obj->segment.unk3A.byte.lower != 1)) {
        func_8005CB04(1);
    ...
    obj68 = obj->unk68[0];
    temp_f2_3 = ((obj68->objModel->animations[obj->segment.unk3A.byte.lower].unk4 * 16) - 17);
    ...
    if ((obj->segment.unk3A.byte.lower == 1) && (obj68->unk10 == -1)) {
    ...
    obj64 = tempObj->unk64;
    if ((obj == tempObj->interactObj->obj) && (tempObj->interactObj->unk14 & 8) && (obj->segment.unk3A.byte.lower == 1)) {
