...
As of November 18, 2023, this is our current score:

&emsp;&emsp;&emsp;&emsp;Decomp progress: 65.67%
...
```
 ...
 -------------- 65.67% Complete (68.46% NON_MATCHING) ---------------
                     # Decompiled functions: 1676
                     # GLOBAL_ASM remaining: 169
