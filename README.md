...
&emsp;&emsp;&emsp;&emsp;Decomp progress [us.v77]: 99.68%
...
```
 ...
 ------------------- 99.68% Complete (99.68% NON_MATCHING) --------------------
 ...
 ------------------------------------------------------------------------------
 We are participating in the Future Fun Land Trophy Race. (Round Four, Lap 1/3)
 ==============================================================================
                     ADVENTURE TWO (Cleanup & Documentation)
 ------------------------------ 65.97% Complete -------------------------------
                          # Documented functions: 1280
                         # Undocumented remaining: 296
                        # Functions named `func_*`: 147
                       # Functions without comments: 296
 -------------------------------- Game Status ---------------------------------
