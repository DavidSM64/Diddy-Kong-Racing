...
As of October 15, 2023, this is our current score:

&emsp;&emsp;&emsp;&emsp;Decomp progress: 59.35%

&emsp;&emsp;&emsp;&emsp;Documentation progress: 33.38%
...
<!-- README_SCORE_BEGIN -->
As of October 15th, 2023, this is our current score:
```
 ====================================================================
                ADVENTURE ONE (ASM -> C Decompilation)
 ------------------------- 59.35% Complete --------------------------
                     # Decompiled functions: 1630
                     # GLOBAL_ASM remaining: 212
