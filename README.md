...
As of April 5, 2025, this is our current score:

&emsp;&emsp;&emsp;&emsp;Decomp progress: 76.98%
...
```
 ...
 ---------------- 76.98% Complete (79.59% NON_MATCHING) ----------------
                      # Decompiled functions: 1839
                       # GLOBAL_ASM remaining: 112
 ...
 -----------------------------------------------------------------------
 We are collecting silver coins in Greenwood Village. (7/8 silver coins)
 =======================================================================
