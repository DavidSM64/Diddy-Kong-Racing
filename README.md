...
&emsp;&emsp;&emsp;&emsp;Decomp progress: 83.16%
...
```
 ...
 --------------- 83.16% Complete (85.06% NON_MATCHING) ----------------
                      # Decompiled functions: 1872
                       # GLOBAL_ASM remaining: 79
 ...
 ----------------------------------------------------------------------
 We are participating in the Trophy Race of Dragon Forest. (Round Four)
 ======================================================================
