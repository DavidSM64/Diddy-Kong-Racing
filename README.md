...
As of July 22, 2025, this is our current score:

&emsp;&emsp;&emsp;&emsp;Decomp progress: 96.77%

&emsp;&emsp;&emsp;&emsp;Documentation progress: 64.20%
...
```
 ...
 ----------------------- 64.20% Complete -----------------------
                  # Documented functions: 1248
                  # Undocumented remaining: 404
                 # Functions named `func_*`: 243
                # Functions without comments: 404
 ------------------------- Game Status -------------------------
