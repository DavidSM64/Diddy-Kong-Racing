...
As of March 1, 2025, this is our current score:

&emsp;&emsp;&emsp;&emsp;Decomp progress: 71.62%
...
<!-- README_SCORE_BEGIN -->
As of March 1st, 2025, this is our current score:
```
 ===============================================
     ADVENTURE ONE (ASM -> C Decompilation)
 ---- 71.62% Complete (74.78% NON_MATCHING) ----
          # Decompiled functions: 1813
           # GLOBAL_ASM remaining: 128
