...
As of October 11, 2023, this is our current score:

&emsp;&emsp;&emsp;&emsp;Decomp progress: 58.51%
...
<!-- README_SCORE_BEGIN -->
As of October 11th, 2023, this is our current score:
```
 ===================================================================
               ADVENTURE ONE (ASM -> C Decompilation)
 ------------------------- 58.51% Complete -------------------------
                    # Decompiled functions: 1613
                     # GLOBAL_ASM remaining: 225
 ...
 -------------------------------------------------------------------
 We are collecting silver coins in Pirate Lagoon. (5/8 silver coins)
 ===================================================================
