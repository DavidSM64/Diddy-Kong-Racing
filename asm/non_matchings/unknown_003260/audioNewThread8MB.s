...
/* 0032B4 800026B4 3C188012 */  lui   $t8, %hi(gVideoRefreshRate) # $t8, 0x8012
/* 0032B8 800026B8 468021A0 */  cvt.s.w $f6, $f4
/* 0032BC 800026BC 8F186170 */  lw    $t8, %lo(gVideoRefreshRate)($t8)
...
/* 003314 80002714 04610005 */  bgez  $v1, .L8000272C2
...
/* 003334 80002734 45000003 */  bc1f  .L800027442
...
/* 003348 80002748 11600004 */  beqz  $t3, .L8000275C2
...
/* 003378 80002778 1701001B */  bne   $t8, $at, .L800027E82
...
/* 0033E0 800027E0 10000005 */  b     .L800027F82
...
.L800027F82:
/* 0033F8 800027F8 3C028012 */  lui   $v0, %hi(dmaBuffs) # $v0, 0x8012
/* 0033FC 800027FC 24429240 */  addiu $v0, %lo(dmaBuffs) # addiu $v0, $v0, -0x6dc0
/* 003400 80002800 3C128012 */  lui   $s2, %hi(dmaBuffs) # $s2, 0x8012
/* 003404 80002804 3C108012 */  lui   $s0, %hi(dmaBuffs+20) # $s0, 0x8012
/* 003408 80002808 AC400004 */  sw    $zero, 4($v0)
/* 00340C 8000280C AC400000 */  sw    $zero, ($v0)
/* 003410 80002810 26109254 */  addiu $s0, %lo(dmaBuffs+20) # addiu $s0, $s0, -0x6dac
/* 003414 80002814 26529240 */  addiu $s2, %lo(dmaBuffs) # addiu $s2, $s2, -0x6dc0
...
/* 003454 80002854 1420FFF1 */  bnez  $at, .L8000281C2
...
/* 0034E0 800028E0 1420FFF8 */  bnez  $at, .L800028C42
...
/* 0034F4 800028F4 10790003 */  beq   $v1, $t9, .L800029042
...
/* 0035B0 800029B0 1611FFF1 */  bne   $s0, $s1, .L800029782
