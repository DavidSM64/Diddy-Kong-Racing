...
/* 0B5178 800B4578 3C03800E */  lui   $v1, %hi(gParticleBehaviorsAssetTableCount) # $v1, 0x800e
/* 0B517C 800B457C 8C632CF4 */  lw    $v1, %lo(gParticleBehaviorsAssetTableCount)($v1)
/* 0B5180 800B4580 3C0E800E */  lui   $t6, %hi(gParticleBehaviorsAssetTable) # $t6, 0x800e
/* 0B5184 800B4584 0083082A */  slt   $at, $a0, $v1
/* 0B5188 800B4588 10200007 */  beqz  $at, .L800B45A8
/* 0B518C 800B458C 3C19800E */   lui   $t9, %hi(gParticleBehaviorsAssetTable) # $t9, 0x800e
/* 0B5190 800B4590 8DCE2CFC */  lw    $t6, %lo(gParticleBehaviorsAssetTable)($t6)
...
.L800B45A8:
/* 0B51A8 800B45A8 8F392CFC */  lw    $t9, %lo(gParticleBehaviorsAssetTable)($t9)
...
/* 0B51C8 800B45C8 3C05800E */  lui   $a1, %hi(gParticleBehaviorsAssetTableCount) # $a1, 0x800e
/* 0B51CC 800B45CC 25C30001 */  addiu $v1, $t6, 1
/* 0B51D0 800B45D0 24A52CF4 */  addiu $a1, %lo(gParticleBehaviorsAssetTableCount) # addiu $a1, $a1, 0x2cf4
/* 0B51D4 800B45D4 AC830000 */  sw    $v1, ($a0)
/* 0B51D8 800B45D8 8CA20000 */  lw    $v0, ($a1)
/* 0B51DC 800B45DC 3C19800E */  lui   $t9, %hi(gParticleBehaviorsAssetTable) # $t9, 0x800e
...
.L800B4604:
/* 0B5204 800B4604 8F392CFC */  lw    $t9, %lo(gParticleBehaviorsAssetTable)($t9)
...
/* 0B5220 800B4620 3C08800E */  lui   $t0, %hi(gParticleBehaviorsAssetTable) # $t0, 0x800e
/* 0B5224 800B4624 25C3FFFF */  addiu $v1, $t6, -1
/* 0B5228 800B4628 04610009 */  bgez  $v1, .L800B4650
/* 0B522C 800B462C AC830000 */   sw    $v1, ($a0)
/* 0B5230 800B4630 3C02800E */  lui   $v0, %hi(gParticleBehaviorsAssetTableCount) # $v0, 0x800e
/* 0B5234 800B4634 24422CF4 */  addiu $v0, %lo(gParticleBehaviorsAssetTableCount) # addiu $v0, $v0, 0x2cf4
.L800B4638:
...
.L800B4650:
/* 0B5250 800B4650 8D082CFC */  lw    $t0, %lo(gParticleBehaviorsAssetTable)($t0)
