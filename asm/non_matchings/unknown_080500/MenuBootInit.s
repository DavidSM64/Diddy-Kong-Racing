...
/* 089134 80088534 3C08800E */  lui   $t0, %hi(D_800DF7C4+2) # $t0, 0x800e
/* 089138 80088538 000E7880 */  sll   $t7, $t6, 2
/* 08913C 8008853C 8508F7C6 */  lh    $t0, %lo(D_800DF7C4+2)($t0)
...
/* 08914C 8008854C 3C0C800E */  lui   $t4, %hi(D_800DF7C4+4) # $t4, 0x800e
/* 089150 80088550 00084880 */  sll   $t1, $t0, 2
/* 089154 80088554 858CF7C8 */  lh    $t4, %lo(D_800DF7C4+4)($t4)
/* 089158 80088558 00895021 */  addu  $t2, $a0, $t1
/* 08915C 8008855C AC39F7DC */  sw    $t9, %lo(D_800DF7DC)($at)
/* 089160 80088560 8D4B0000 */  lw    $t3, ($t2)
# Accessing D_800DF7DC[1] and D_800DF7DC[2].
/* 089164 80088564 3C01800E */  lui   $at, %hi(D_800DF7DC+8) # $at, 0x800e
/* 089168 80088568 000C6880 */  sll   $t5, $t4, 2
/* 08916C 8008856C 008D7021 */  addu  $t6, $a0, $t5
/* 089170 80088570 AC2BF7E4 */  sw    $t3, %lo(D_800DF7DC+8)($at)
/* 089174 80088574 8DCF0000 */  lw    $t7, ($t6)
                              # The extra lui is here.
/* 089178 80088578 3C03800E */  lui   $v1, %hi(D_800DF7DC+0x18) # $v1, 0x800e
/* 08917C 8008857C 3C02800E */  lui   $v0, %hi(D_800DF7C4+6) # $v0, 0x800e
/* 089180 80088580 3C05800E */  lui   $a1, %hi(D_800DF7C4+22) # $a1, 0x800e
/* 089184 80088584 24A5F7DA */  addiu $a1, %lo(D_800DF7C4+22) # addiu $a1, $a1, -0x826
/* 089188 80088588 2442F7CA */  addiu $v0, %lo(D_800DF7C4+6) # addiu $v0, $v0, -0x836
/* 08918C 8008858C 2463F7F4 */  addiu $v1, %lo(D_800DF7DC+0x18) # addiu $v1, $v1, -0x80c
/* 089190 80088590 AC2FF7EC */  sw    $t7, %lo(D_800DF7DC+0x10)($at)
.L80088594:
