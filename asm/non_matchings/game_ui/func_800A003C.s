...
/* 0A0C40 800A0040 3C028012 */  lui   $v0, %hi(gNumHudElements) # $v0, 0x8012
/* 0A0C44 800A0044 8C426CF8 */  lw    $v0, %lo(gNumHudElements)($v0)
...
/* 0A0C6C 800A006C 3C128012 */  lui   $s2, %hi(gHudElements) # $s2, 0x8012
/* 0A0C70 800A0070 26526CF4 */  addiu $s2, %lo(gHudElements) # addiu $s2, $s2, 0x6cf4
...
.L800A0108:
/* 0A0D08 800A0108 3C028012 */  lui   $v0, %hi(gNumHudElements) # $v0, 0x8012
/* 0A0D0C 800A010C 01916821 */  addu  $t5, $t4, $s1
/* 0A0D10 800A0110 ADA00000 */  sw    $zero, ($t5)
/* 0A0D14 800A0114 8C426CF8 */  lw    $v0, %lo(gNumHudElements)($v0)
...
/* 0A0D30 800A0130 3C128012 */  lui   $s2, %hi(gHudElements) # $s2, 0x8012
...
/* 0A0D44 800A0144 26526CF4 */   addiu $s2, %lo(gHudElements) # addiu $s2, $s2, 0x6cf4
/* 0A0D48 800A0148 8E840000 */  lw    $a0, ($s4)
/* 0A0D4C 800A014C 0C01C450 */  jal   free_from_memory_pool
/* 0A0D50 800A0150 00000000 */   nop   
/* 0A0D54 800A0154 3C018012 */  lui   $at, %hi(gNumHudElements) # $at, 0x8012
/* 0A0D58 800A0158 AC206CF8 */  sw    $zero, %lo(gNumHudElements)($at)
