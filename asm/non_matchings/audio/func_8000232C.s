...
/* 002F50 80002350 0C031E94 */  jal   alCSPGetState
...
/* 002F80 80002380 8DEF5CF8 */  lw    $t7, %lo(ALSeqFile_80115CF8)($t7)
...
/* 002FC4 800023C4 0C032158 */  jal   alCSPSetSeq
/* 002FC8 800023C8 02402825 */   move  $a1, $s2
/* 002FCC 800023CC 0C032168 */  jal   alCSPPlay
/* 002FD0 800023D0 02002025 */   move  $a0, $s0
/* 002FD4 800023D4 3C0C800E */  lui   $t4, %hi(gMusicPlayer) # $t4, 0x800e
/* 002FD8 800023D8 8D8CC630 */  lw    $t4, %lo(gMusicPlayer)($t4)
...
/* 002FF4 800023F4 3C108011 */  lui   $s0, %hi(sMusicPool) # $s0, 0x8011
/* 002FF8 800023F8 26105D1C */  addiu $s0, %lo(sMusicPool) # addiu $s0, $s0, 0x5d1c
...
/* 00300C 8000240C 0C000664 */  jal   set_relative_volume_for_music
...
/* 003024 80002424 3C018011 */  lui   $at, %hi(sMusicTempo) # $at, 0x8011
...
/* 003040 80002440 0C00054D */  jal   musicSetTempo
/* 003044 80002444 00000000 */   nop   
/* 003048 80002448 3C028011 */  lui   $v0, %hi(sMusicPool) # $v0, 0x8011
/* 00304C 8000244C 8C425D1C */  lw    $v0, %lo(sMusicPool)($v0)
/* 003050 80002450 10000003 */  b     .L80002460
/* 003054 80002454 926B0000 */   lbu   $t3, ($s3)
.L80002458:
/* 003058 80002458 A42A5D30 */  sh    $t2, %lo(sMusicTempo)($at)
...
/* 0030F4 800024F4 3C108011 */  lui   $s0, %hi(sMusicPool) # $s0, 0x8011
/* 0030F8 800024F8 26105D1C */  addiu $s0, %lo(sMusicPool) # addiu $s0, $s0, 0x5d1c
...
/* 00310C 8000250C 0C0006C3 */  jal   sfxSetRelativeVolume
...
/* 003138 80002538 0C0005F5 */  jal   sfxSetTempo
