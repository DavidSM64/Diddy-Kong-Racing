...
/* 05D134 8005C534 0C000741 */  jal   play_sound_global
...
/* 05D14C 8005C54C 3C01800E */  lui   $at, %hi(D_800E6A10 + 4) # $at, 0x800e
/* 05D150 8005C550 C604002C */  lwc1  $f4, 0x2c($s0)
/* 05D154 8005C554 C4296A10 */  lwc1  $f9, %lo(D_800E6A10)($at)
/* 05D158 8005C558 C4286A14 */  lwc1  $f8, %lo(D_800E6A10 + 4)($at)
...
/* 05D228 8005C628 3C01800E */   lui   $at, %hi(D_800E6A18 + 4) # $at, 0x800e
...
/* 05D26C 8005C66C C4286A1C */  lwc1  $f8, %lo(D_800E6A18 + 4)($at)
/* 05D270 8005C670 3C01800E */  lui   $at, %hi(D_800E6A20 + 4) # $at, 0x800e
...
/* 05D288 8005C688 C42A6A24 */  lwc1  $f10, %lo(D_800E6A20 + 4)($at)
...
/* 05D498 8005C898 3C01800E */  lui   $at, %hi(D_800E6A28 + 4) # $at, 0x800e
/* 05D49C 8005C89C C4296A28 */  lwc1  $f9, %lo(D_800E6A28)($at)
/* 05D4A0 8005C8A0 C4286A2C */  lwc1  $f8, %lo(D_800E6A28 + 4)($at)
...
/* 05D4C0 8005C8C0 0C01C1D4 */  jal   arctan2_f
