...
/* 06F930 8006ED30 3C118012 */  lui   $s1, %hi(gDisplayLists) # $s1, 0x8012
/* 06F934 8006ED34 263111F0 */  addiu $s1, %lo(gDisplayLists) # addiu $s1, $s1, 0x11f0
...
/* 06F954 8006ED54 3C18800E */  lui   $t8, %hi(gNumHudTrisPerPlayer) # $t8, 0x800e
/* 06F958 8006ED58 2718D3E0 */  addiu $t8, %lo(gNumHudTrisPerPlayer) # addiu $t8, $t8, -0x2c20
/* 06F95C 8006ED5C 3C19800E */  lui   $t9, %hi(gNumF3dCmdsPerPlayer) # $t9, 0x800e
/* 06F960 8006ED60 00027880 */  sll   $t7, $v0, 2
/* 06F964 8006ED64 01F84021 */  addu  $t0, $t7, $t8
/* 06F968 8006ED68 2739D3B0 */  addiu $t9, %lo(gNumF3dCmdsPerPlayer) # addiu $t9, $t9, -0x2c50
/* 06F96C 8006ED6C 01F91821 */  addu  $v1, $t7, $t9
/* 06F970 8006ED70 3C0C800E */  lui   $t4, %hi(gNumHudMatPerPlayer) # $t4, 0x800e
/* 06F974 8006ED74 3C0D800E */  lui   $t5, %hi(gNumHudVertsPerPlayer) # $t5, 0x800e
/* 06F978 8006ED78 8C780000 */  lw    $t8, ($v1)
/* 06F97C 8006ED7C 8D0E0000 */  lw    $t6, ($t0)
/* 06F980 8006ED80 25ADD3C0 */  addiu $t5, %lo(gNumHudVertsPerPlayer) # addiu $t5, $t5, -0x2c40
/* 06F984 8006ED84 258CD3D0 */  addiu $t4, %lo(gNumHudMatPerPlayer) # addiu $t4, $t4, -0x2c30
...
/* 06FA60 8006EE60 3C018012 */  lui   $at, %hi(gHudMatrices) # $at, 0x8012
/* 06FA64 8006EE64 000218C0 */  sll   $v1, $v0, 3
/* 06FA68 8006EE68 00706021 */  addu  $t4, $v1, $s0
/* 06FA6C 8006EE6C 3C0A8012 */  lui   $t2, %hi(gHudMatrices) # $t2, 0x8012
/* 06FA70 8006EE70 AC2C1200 */  sw    $t4, %lo(gHudMatrices)($at)
/* 06FA74 8006EE74 8DC60000 */  lw    $a2, ($t6)
/* 06FA78 8006EE78 254A1200 */  addiu $t2, %lo(gHudMatrices) # addiu $t2, $t2, 0x1200
/* 06FA7C 8006EE7C 8D4F0000 */  lw    $t7, ($t2)
/* 06FA80 8006EE80 00063980 */  sll   $a3, $a2, 6
/* 06FA84 8006EE84 8FB90024 */  lw    $t9, 0x24($sp)
/* 06FA88 8006EE88 3C018012 */  lui   $at, %hi(gHudTriangles) # $at, 0x8012
/* 06FA8C 8006EE8C 00EFC021 */  addu  $t8, $a3, $t7
/* 06FA90 8006EE90 3C0B8012 */  lui   $t3, %hi(gHudTriangles) # $t3, 0x8012
/* 06FA94 8006EE94 AC381220 */  sw    $t8, %lo(gHudTriangles)($at)
/* 06FA98 8006EE98 8F280000 */  lw    $t0, ($t9)
/* 06FA9C 8006EE9C 256B1220 */  addiu $t3, %lo(gHudTriangles) # addiu $t3, $t3, 0x1220
/* 06FAA0 8006EEA0 8D6D0000 */  lw    $t5, ($t3)
/* 06FAA4 8006EEA4 00084900 */  sll   $t1, $t0, 4
/* 06FAA8 8006EEA8 3C018012 */  lui   $at, %hi(gHudVertices) # $at, 0x8012
/* 06FAAC 8006EEAC 012D6021 */  addu  $t4, $t1, $t5
/* 06FAB0 8006EEB0 AC2C1210 */  sw    $t4, %lo(gHudVertices)($at)
/* 06FAB4 8006EEB4 3C018012 */  lui   $at, %hi(gHudMatrices+4) # $at, 0x8012
/* 06FAB8 8006EEB8 00657021 */  addu  $t6, $v1, $a1
/* 06FABC 8006EEBC AC2E1204 */  sw    $t6, %lo(gHudMatrices+4)($at)
/* 06FAC0 8006EEC0 8D4F0004 */  lw    $t7, 4($t2)
/* 06FAC4 8006EEC4 3C018012 */  lui   $at, %hi(gHudTriangles+4) # $at, 0x8012
/* 06FAC8 8006EEC8 00EFC021 */  addu  $t8, $a3, $t7
/* 06FACC 8006EECC AC381224 */  sw    $t8, %lo(gHudTriangles+4)($at)
/* 06FAD0 8006EED0 8D790004 */  lw    $t9, 4($t3)
/* 06FAD4 8006EED4 3C018012 */  lui   $at, %hi(gHudVertices+4) # $at, 0x8012
/* 06FAD8 8006EED8 01396821 */  addu  $t5, $t1, $t9
/* 06FADC 8006EEDC AC2D1214 */  sw    $t5, %lo(gHudVertices+4)($at)
/* 06FAE0 8006EEE0 3C018012 */  lui   $at, %hi(gCurrNumF3dCmdsPerPlayer) # $at, 0x8012
/* 06FAE4 8006EEE4 AC223528 */  sw    $v0, %lo(gCurrNumF3dCmdsPerPlayer)($at)
/* 06FAE8 8006EEE8 3C018012 */  lui   $at, %hi(gCurrNumHudMatPerPlayer) # $at, 0x8012
/* 06FAEC 8006EEEC AC26352C */  sw    $a2, %lo(gCurrNumHudMatPerPlayer)($at)
/* 06FAF0 8006EEF0 8FAC0020 */  lw    $t4, 0x20($sp)
/* 06FAF4 8006EEF4 3C018012 */  lui   $at, %hi(gCurrNumHudTrisPerPlayer) # $at, 0x8012
/* 06FAF8 8006EEF8 AC283530 */  sw    $t0, %lo(gCurrNumHudTrisPerPlayer)($at)
/* 06FAFC 8006EEFC 8D8E0000 */  lw    $t6, ($t4)
/* 06FB00 8006EF00 3C018012 */  lui   $at, %hi(gCurrNumHudVertsPerPlayer) # $at, 0x8012
...
/* 06FB2C 8006EF2C 3C048012 */  lui   $a0, %hi(gCurrDisplayList) # $a0, 0x8012
/* 06FB30 8006EF30 248411F8 */  addiu $a0, %lo(gCurrDisplayList) # addiu $a0, $a0, 0x11f8
/* 06FB34 8006EF34 3C0D8012 */  lui   $t5, %hi(gHudMatrices) # $t5, 0x8012
