...
.L800843D0:
/* 084FD0 800843D0 3C0B8012 */  lui   $t3, %hi(gIgnorePlayerInputTime) # $t3, 0x8012
/* 084FD4 800843D4 8D6B63C4 */  lw    $t3, %lo(gIgnorePlayerInputTime)($t3)
...
.L80084490:
/* 085090 80084490 0C000326 */  jal   set_music_fade_timer
...
/* 08529C 8008469C 0C0211CD */  jal   unload_big_font_1
...
/* 0852C0 800846C0 0C0211CD */  jal   unload_big_font_1
...
.L800846D8:
/* 0852D8 800846D8 0C0211CD */  jal   unload_big_font_1
...
/* 085304 80084704 0C0211CD */  jal   unload_big_font_1
...
.L8008471C:
/* 08531C 8008471C 3C018012 */  lui   $at, %hi(gIgnorePlayerInputTime) # $at, 0x8012
/* 085320 80084720 AC2063C4 */  sw    $zero, %lo(gIgnorePlayerInputTime)($at)
.L80084724:
