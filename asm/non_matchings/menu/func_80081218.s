...
/* 081F88 80081388 3C028012 */  lui   $v0, %hi(gMenuAssets) # $v0, 0x8012
/* 081F8C 8008138C 3C038012 */  lui   $v1, %hi(gMenuAssetActive) # $v1, 0x8012
/* 081F90 80081390 24636750 */  addiu $v1, %lo(gMenuAssetActive) # addiu $v1, $v1, 0x6750
/* 081F94 80081394 24426550 */  addiu $v0, %lo(gMenuAssets) # addiu $v0, $v0, 0x6550
.L80081398:
