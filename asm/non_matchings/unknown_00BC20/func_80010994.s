...
/* 01162C 80010A2C 3C048012 */   lui   $a0, %hi(D_8011AEF0) # $a0, 0x8012
...
/* 01165C 80010A5C 3C018012 */  lui   $at, 0x8012
/* 011660 80010A60 002B0821 */  addu  $at, $at, $t3
/* 011664 80010A64 2484AEF0 */  addiu $a0, %lo(D_8011AEF0) # addiu $a0, $a0, -0x5110
/* 011668 80010A68 A020AD22 */  sb    $zero, -0x52de($at)
/* 01166C 80010A6C 8C8C0000 */  lw    $t4, ($a0)
/* 011670 80010A70 00009825 */  move  $s3, $zero
/* 011674 80010A74 19800021 */  blez  $t4, .L80010AFC
/* 011678 80010A78 3C158012 */   lui   $s5, %hi(D_8011AEE4) # $s5, 0x8012
/* 01167C 80010A7C 26B5AEE4 */  addiu $s5, %lo(D_8011AEE4) # addiu $s5, $s5, -0x511c
...
.L80010AFC:
/* 0116FC 80010AFC 3C158012 */  lui   $s5, %hi(D_8011AEE4) # $s5, 0x8012
/* 011700 80010B00 0C0050AE */  jal   func_800142B8
/* 011704 80010B04 26B5AEE4 */   addiu $s5, %lo(D_8011AEE4) # addiu $s5, $s5, -0x511c
...
.L80010BB4:
/* 0117B4 80010BB4 3C138012 */  lui   $s3, %hi(D_8011AE5C) # $s3, 0x8012
/* 0117B8 80010BB8 3C118012 */  lui   $s1, %hi(D_8011AE60) # $s1, 0x8012
/* 0117BC 80010BBC 8E73AE5C */  lw    $s3, %lo(D_8011AE5C)($s3)
...
/* 0117D8 80010BD8 3C168012 */  lui   $s6, %hi(D_8011AE58) # $s6, 0x8012
/* 0117DC 80010BDC 26D6AE58 */  addiu $s6, %lo(D_8011AE58) # addiu $s6, $s6, -0x51a8
...
.L80010D00:
/* 011900 80010D00 3C0C8012 */  lui   $t4, %hi(D_8011AEF0) # $t4, 0x8012
/* 011904 80010D04 8D8CAEF0 */  lw    $t4, %lo(D_8011AEF0)($t4)
/* 011908 80010D08 3C168012 */  lui   $s6, %hi(D_8011AE58) # $s6, 0x8012
/* 01190C 80010D0C 26D6AE58 */  addiu $s6, %lo(D_8011AE58) # addiu $s6, $s6, -0x51a8
...
/* 011934 80010D34 3C0F8012 */  lui   $t7, %hi(D_8011AEF0) # $t7, 0x8012
/* 011938 80010D38 8DEFAEF0 */  lw    $t7, %lo(D_8011AEF0)($t7)
...
/* 011958 80010D58 3C078012 */   lui   $a3, %hi(D_8011AEF0) # $a3, 0x8012
/* 01195C 80010D5C 8CE7AEF0 */  lw    $a3, %lo(D_8011AEF0)($a3)
...
/* 0119A8 80010DA8 3C078012 */  lui   $a3, %hi(D_8011AEF0) # $a3, 0x8012
/* 0119AC 80010DAC 8CE7AEF0 */  lw    $a3, %lo(D_8011AEF0)($a3)
...
/* 011AE0 80010EE0 3C028012 */  lui   $v0, %hi(D_8011AE5C) # $v0, 0x8012
/* 011AE4 80010EE4 8C42AE5C */  lw    $v0, %lo(D_8011AE5C)($v0)
...
/* 011B3C 80010F3C 3C028012 */  lui   $v0, %hi(D_8011AE5C) # $v0, 0x8012
/* 011B40 80010F40 8C42AE5C */  lw    $v0, %lo(D_8011AE5C)($v0)
...
/* 011B94 80010F94 0C004013 */  jal   func_8001004C
...
.L80010FB4:
/* 011BB4 80010FB4 3C078012 */  lui   $a3, %hi(D_8011AEF0) # $a3, 0x8012
/* 011BB8 80010FB8 8CE7AEF0 */  lw    $a3, %lo(D_8011AEF0)($a3)
...
/* 011BE0 80010FE0 3C078012 */  lui   $a3, %hi(D_8011AEF0) # $a3, 0x8012
/* 011BE4 80010FE4 8CE7AEF0 */  lw    $a3, %lo(D_8011AEF0)($a3)
...
/* 011BF8 80010FF8 3C078012 */  lui   $a3, %hi(D_8011AEF0) # $a3, 0x8012
/* 011BFC 80010FFC 8CE7AEF0 */  lw    $a3, %lo(D_8011AEF0)($a3)
