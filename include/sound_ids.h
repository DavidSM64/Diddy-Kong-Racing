...
enum SoundID {
    ...
    SOUND_UNK352,
    SOUND_UNK353,
    SOUND_VOICE_KRUNCH_BAA,
    SOUND_VOICE_BUMPER_YOW,
    SOUND_VOICE_TIPTUP_OW,
    SOUND_VOICE_CONKER_YOWOW,
    SOUND_VOICE_TIMBER_YEAH2,
    SOUND_VOICE_BANJO_YAHOO2,
    SOUND_VOICE_DRUMSTICK_WEH,
    SOUND_VOICE_PIPSY_YAHOO,
    SOUND_VOICE_TT_WAHEY,
    SOUND_VOICE_DIDDY_HOOHOO,
    SOUND_UNK364,
    SOUND_UNK365,
    SOUND_VOICE_KRUNCH_HAHA,
    SOUND_VOICE_BUMPER_YEAH,
    SOUND_VOICE_TIPTIP_WOHOAH,
    SOUND_VOICE_CONKER_HEHE,
    SOUND_VOICE_TIMBER_YIPPEE,
    SOUND_VOICE_BANJO_WOAH2,
    SOUND_VOICE_DRUMSTICK_BWAK2,
    SOUND_VOICE_PIPSY_YIPPEE,
    SOUND_VOICE_TT_HOHO,
    SOUND_VOICE_DIDDY_HAHA,
    SOUND_UNK376,
    SOUND_UNK377,
    SOUND_VOICE_KRUNCH_HEY,
    SOUND_VOICE_BUMPER_WOOHOO,
    SOUND_VOICE_TIPTUP_WOW,
    SOUND_VOICE_CONKER_HEEHEE,
    SOUND_VOICE_TIMBER_WOAH,
    SOUND_VOICE_BANJO_WAHOY,
    SOUND_VOICE_DRUMSTICK_WAH2,
    SOUND_VOICE_PIPSY_YOW,
    SOUND_VOICE_TT_WAHEE,
    SOUND_VOICE_DIDDY_LAUGH3,
    SOUND_UNK388,
    SOUND_UNK389,
    SOUND_VOICE_KRUNCH_HAHA2,
    SOUND_VOICE_BUMPER_HOHO,
    SOUND_VOICE_TIPTUP_HAHA,
    SOUND_VOICE_CONKER_LAUGH,
    SOUND_VOICE_TIMBER_LAUGH,
    SOUND_VOICE_BANJO_HAHOO,
    SOUND_VOICE_DRUMSTICK_BWAK3,
    SOUND_VOICE_PIPSY_WAHOO,
    SOUND_VOICE_TT_HEHE,
    SOUND_VOICE_DIDDY_HEHEHAHA,
    SOUND_UNK400,
    SOUND_UNK401,
    SOUND_VOICE_VOICE_KRUNCH_HAHA2,
    SOUND_VOICE_BUMPER_LAUGH,
    SOUND_VOICE_TIPTUP_LAUGH,
    SOUND_VOICE_CONKER_WOOPDEEDOO,
    SOUND_VOICE_TIMBER_LAUGH2,
    SOUND_VOICE_BANJO_HOHO,
    SOUND_VOICE_DRUMSTICK_BWAH,
    SOUND_VOICE_PIPSY_HEHE,
    SOUND_VOICE_TT_YIPPEE,
    SOUND_VOICE_DIDDY_WOOHOO,
    SOUND_UNK412,
    SOUND_UNK413,
    SOUND_VOICE_KRUNCH_LAUGH2,
    SOUND_VOICE_BUMPER_WOOHOO2,
    SOUND_VOICE_TIPTUP_HOHO,
    SOUND_VOICE_CONKER_YEHAHA2,
    SOUND_VOICE_TIMBER_COOL,
    SOUND_VOICE_BANJO_HAHOO2,
    SOUND_VOICE_DRUMSTICK_BWAK4,
    SOUND_VOICE_PIPSY_LAUGH2,
    SOUND_VOICE_TT_YAHOO,
    SOUND_VOICE_DIDDY_YEE,
    SOUND_UNK424,
    SOUND_UNK425,
    SOUND_VOICE_KRUNCH_LAUGH3,
    SOUND_VOICE_BUMPER_LAUGH2,
    SOUND_VOICE_TIPTUP_YEAH,
    SOUND_VOICE_CONKER_YOO,
    SOUND_VOICE_TIMBER_WOW2,
    SOUND_VOICE_BANJO_GUHHUH2,
    SOUND_VOICE_DRUMSTICK_BWAK5,
    SOUND_VOICE_PIPSY_EEKEEK,
    SOUND_VOICE_TT_WAHEY2,
    SOUND_VOICE_DIDDY_HEHEHAHA2,
    SOUND_UNK436,
    SOUND_UNK437,
    SOUND_VOICE_KRUNCH_HOHOO2,
    SOUND_VOICE_BUMPER_WAHEY,
    SOUND_VOICE_TIPTUP_HAHAHO,
    SOUND_VOICE_CONKER_WOO,
    SOUND_VOICE_TIMBER_RAGH2,
    SOUND_VOICE_BANJO_YAHOO3,
    SOUND_VOICE_DRUMSTICK_BWAK6,
    SOUND_VOICE_PIPSY_EEK,
    SOUND_VOICE_TT_HEHOO,
    SOUND_VOICE_DIDDY_WOHOHA,
    SOUND_UNK448,
    SOUND_UNK449,
    SOUND_VOICE_KRUNCH_ACK,
    SOUND_VOICE_BUMPER_OHNO2,
    SOUND_VOICE_TIPTUP_HEY,
    SOUND_VOICE_CONKER_ACK,
    SOUND_VOICE_TIMBER_WAH,
    SOUND_VOICE_BANJO_GUHHUH3,
    SOUND_VOICE_DRUMSTICK_BWAH2,
    SOUND_VOICE_PIPSY_UHOH2,
    SOUND_VOICE_TT_OW,
    SOUND_VOICE_DIDDY_EEK,
    SOUND_UNK460,
    SOUND_UNK461,
    SOUND_VOICE_KRUNCH_ARGH,
    SOUND_VOICE_BUMPER_UH2,
    SOUND_VOICE_TIPTUP_OW2,
    SOUND_VOICE_CONKER_YOO2,
    SOUND_VOICE_TIMBER_UHOH,
    SOUND_VOICE_BANJO_WOAH3,
    SOUND_VOICE_DRUMSTICK_AGH,
    SOUND_VOICE_PIPSY_OW,
    SOUND_VOICE_TT_OW2,
    SOUND_VOICE_DIDDY_OOH,
    SOUND_UNK472,
    SOUND_UNK473,
    SOUND_VOICE_KRUNCH_HEY2,
    SOUND_VOICE_BUMPER_YOW2,
    SOUND_VOICE_TIPTUP_WOW2,
    SOUND_VOICE_CONKER_YOO3,
    SOUND_VOICE_TIMBER_UHUH,
    SOUND_VOICE_BANJO_WOAH4,
    SOUND_VOICE_DRUMSTICK_BWAH3,
    SOUND_VOICE_PIPSY_OOH,
    SOUND_VOICE_TT_WOAH2,
    SOUND_VOICE_DIDDY_OOH2,
    SOUND_UNK484,
    SOUND_UNK485,
    SOUND_VOICE_KRUNCH_AH,
    SOUND_VOICE_BUMPER_UH3,
    SOUND_VOICE_TIPTUP_OW3,
    SOUND_VOICE_CONKER_AHH2,
    SOUND_VOICE_TIMBER_UHOH2,
    SOUND_VOICE_BANJO_HOHO2,
    SOUND_VOICE_DRUMSTICK_BWAK7,
    SOUND_VOICE_PIPSY_OW2,
    SOUND_VOICE_TT_OW3,
    SOUND_VOICE_DIDDY_NARGH,
    SOUND_UNK496,
    SOUND_UNK497,
    SOUND_VOICE_KRUNCH_HOHOO3,
    SOUND_VOICE_BUMPER_OW,
    SOUND_VOICE_TIPTUP_AHH2,
    SOUND_VOICE_CONKER_YOO4,
    SOUND_VOICE_TIMBER_RAGH3,
    SOUND_VOICE_BANJO_AWW,
    SOUND_VOICE_DRUMSTICK_AGH2,
    SOUND_VOICE_PIPSY_EEKEEK2,
    SOUND_VOICE_TT_HAHOW,
    SOUND_VOICE_DIDDY_HEY,
    SOUND_UNK508,
    SOUND_UNK509,
    SOUND_VOICE_KRUNCH_BAH,
    SOUND_VOICE_BUMPER_WOAH,
    SOUND_VOICE_TIPTUP_AHH3,
    SOUND_VOICE_CONKER_YOO5,
    SOUND_VOICE_TIMBER_WOW3,
    SOUND_VOICE_BANJO_DOH,
    SOUND_VOICE_DRUMSTICK_BWAK8,
    SOUND_VOICE_PIPSY_YOW2,
    SOUND_VOICE_TT_OOH,
    SOUND_VOICE_DIDDY_WOAH2,
    SOUND_UNK520,
    SOUND_UNK521,
    SOUND_VOICE_KRUNCH_EHH2,
    SOUND_VOICE_BUMPER_YOW3,
    SOUND_VOICE_TIPTUP_WATCHOUT,
    SOUND_VOICE_CONKER_ACK2,
    SOUND_VOICE_TIMBER_AH,
    SOUND_VOICE_BANJO_OW,
    SOUND_VOICE_DRUMSTICK_WAH3,
    SOUND_VOICE_PIPSY_UHOH3,
    SOUND_UNK530,
    SOUND_VOICE_DIDDY_OW,
    SOUND_UNK532,
    SOUND_UNK533,
    SOUND_VOICE_KRUNCH_HEY3,
    SOUND_VOICE_BUMPER_OOH,
    SOUND_VOICE_TIPTUP_HOHO2,
    SOUND_VOICE_CONKER_YOO6,
    SOUND_VOICE_TIMBER_RAGH4,
    SOUND_VOICE_BANJO_OW2,
    SOUND_VOICE_DRUMSTICK_BOK,
    SOUND_VOICE_PIPSY_EEKEEK3,
    SOUND_VOICE_TT_WOAH3,
    SOUND_VOICE_DIDDY_OW2,
