...
#define DKR_RM_UNKNOWN2   AA_DEF | RD_DEF | CLR_ON_CVG | FORCE_BL | CVG_DST_WRAP | ZMODE_OPA
...
#define DKR_RM_UNKNOWN4   AA_DEF | Z_CMP | IM_RD | CVG_X_ALPHA | FORCE_BL | CVG_DST_CLAMP | ZMODE_XLU
