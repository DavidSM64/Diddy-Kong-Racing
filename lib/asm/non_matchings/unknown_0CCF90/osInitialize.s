...
.L800CC7BC:
/* 0CD3BC 800CC7BC 3C0DA460 */  lui   $t5, %hi(PI_STATUS_REG) # $t5, 0xa460
/* 0CD3C0 800CC7C0 8DAC0010 */  lw    $t4, %lo(PI_STATUS_REG)($t5)
/* 0CD3C4 800CC7C4 318F0003 */  andi  $t7, $t4, 3
/* 0CD3C8 800CC7C8 11E00008 */  beqz  $t7, .L800CC7EC
/* 0CD3CC 800CC7CC AFAC0030 */   sw    $t4, 0x30($sp)
.L800CC7D0:
/* 0CD3D0 800CC7D0 3C0EA460 */  lui   $t6, %hi(PI_STATUS_REG) # $t6, 0xa460
/* 0CD3D4 800CC7D4 8DD80010 */  lw    $t8, %lo(PI_STATUS_REG)($t6)
...
.L800CC7EC:
/* 0CD3EC 800CC7EC 3C0AA500 */  lui   $t2, %hi(LEO_STATUS) # $t2, 0xa500
/* 0CD3F0 800CC7F0 8D4B0508 */  lw    $t3, %lo(LEO_STATUS)($t2)
...
/* 0CD414 800CC814 0C0351FC */  jal   __osSetHWIntrRoutine
