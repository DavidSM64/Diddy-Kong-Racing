...
/* 0D732C 800D672C 3C13800E */  lui   $s3, %hi(udigs) # $s3, 0x800e
/* 0D7330 800D6730 10000003 */  b     .L800D6740
/* 0D7334 800D6734 26734934 */   addiu $s3, %lo(udigs) # addiu $s3, $s3, 0x4934
.L800D6738:
/* 0D7338 800D6738 3C13800E */  lui   $s3, %hi(ldigs) # $s3, 0x800e
/* 0D733C 800D673C 26734920 */  addiu $s3, %lo(ldigs) # addiu $s3, $s3, 0x4920
.L800D6740:
...
/* 0D74AC 800D68AC 0C035D1C */  jal   lldiv
